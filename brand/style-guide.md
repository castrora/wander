...
### What Pierway Is
An AI-powered walking experience that converts cruise passenger foot traffic into verified, performance-based commerce for local merchants.
...
### The Gap We Fill
| Platform | What They Own |
|---|---|
| Google Maps | Directions |
| Yelp / TripAdvisor | Opinions |
| Shore excursion companies | Scheduled tours |
| **Pierway** | **Verified pedestrian commerce** |
...
**2. Earned Confidence**
We state things as facts, not aspirations. We don't hedge unnecessarily. We don't over-qualify. The product does what it says. The model works the way we say it works. We don't need enthusiasm to compensate for uncertainty.

> ❌ "We hope to help passengers discover Seattle in a meaningful way."
> ✅ "Passengers scan, get a personalized route, and discover Seattle on their own terms."

**3. Industry-Literate**
We speak the language of the maritime and hospitality industry. We know what a port day is. We know the difference between Pier 91 and Pier 66. We know shore excursions are a revenue center, not a goodwill offering.

> ❌ "When the cruise ship arrives and people get off..."
> ✅ "During Seattle port days, disembarking passengers have 4–6 hours and no car."

**4. Direct**
Short sentences. No buzzwords. No "innovative," "revolutionary," "disruptive," or "seamless." Those words cost credibility. We earn attention with precision, not adjectives.

> ❌ "Leveraging cutting-edge AI technology to create seamless, innovative experiences..."
> ✅ "AI generates the route. The passenger walks. The merchant pays only when they arrive."
...
**Tone:** Operational, collaborative, specific to their infrastructure.
They care about: passenger experience at the terminal, vendor/partner process, liability, port authority alignment.
Lead with: process (how QR placement works), zero cost, what we need from them (a spot on the wall).

### Cruise Lines (Shore Excursions / BD)
**Tone:** Complementary, not competitive. Revenue-aware.
They care about: not cannibalizing paid shore excursions, passenger satisfaction scores, zero obligation to their operation.
Lead with: it's free to passengers and the cruise line, it's additive to their offering, no integration required.

### Hotels
**Tone:** Guest experience focused, property-specific.
They care about: adding value to cruise packages, differentiating their concierge offering, not adding complexity.
Lead with: what's in it for the guest, zero cost to the hotel, how little effort it takes.

### Tourism Organizations (DMOs)
**Tone:** Partnership-minded, data-forward, destination development.
They care about: activating local merchants, getting cruise visitors to spend money in the city, distributing economic benefit beyond the waterfront.
Lead with: merchant activation, data on visitor movement, alignment with their destination mandate.
...
- Name the season and city where relevant
...
**Avoid:**
- `Exciting new partnership opportunity!`
- `Following up on my last email`
- `Quick question about your guests`
...
- Body: `1rem / 1.05rem`
- Small / Labels: `0.8rem–0.875rem`

### Logo

The Pierway mark is a pier in perspective: three converging rails leading to a teal horizon dot. The cross planks narrow as they recede, creating a clear depth effect.

**Usage rules:**
- Minimum size: 24px tall (icon only), 34px tall (full lockup)
- Clear space: equal to the height of the teal dot on all sides
- Preferred: full lockup (mark + wordmark) on white or light backgrounds
- Acceptable: mark only for favicon / small contexts
- Do not: recolor, rotate, or separate the mark from the wordmark in external use
- Do not: use on dark backgrounds without a white/light version (not yet created)
...
| Term | Use | Avoid |
|---|---|---|
| The product | Pierway | "the app," "the tool," "our platform" |
| Users | passengers, walkers | "users," "consumers," "customers" |
| Distribution partners | partners | "clients," "customers," "vendors" |
| Paying businesses | merchants | "advertisers," "sponsors," "brands" |
| The fee model | CPV / Cost Per Verified Visit | "pay-per-click," "ads," "impressions" |
| The route output | walking route, route | "itinerary," "tour," "walk" |
| The QR placement | QR code | "code," "tag," "label" |
| Port arrival days | port day | "shore day," "port stop," "layover" |

---

## 8. What Pierway Is Not

These distinctions matter when talking to partners and press.

| We are not... | Because... |
|---|---|
| A tour app | Tours are scheduled, static, and pre-paid. Pierway is dynamic, AI-generated, and free to the user. |
| An advertising platform | Ads are paid upfront for impressions. Pierway charges only on confirmed visits. |
| A review platform | We don't curate merchant quality through reviews. We embed merchants contextually in routes. |
| A loyalty program | There's no points system. No account required. No recurring engagement model. |
| A GPS navigation app | We tell stories, not just directions. Navigation is the vehicle, not the product. |
...
*This document lives at `brand/style-guide.md`. Update when messaging evolves or new audiences are added.*
